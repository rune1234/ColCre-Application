...
//redacron alteration. task_id was not there before. It is used to assign tasks only to project members
        $url = "index.php?option=com_pfusers&view=userref&filter_access=" . $access . "&tmpl=component&layout=select2&format=json&task_id=".JRequest::getInt('id');
